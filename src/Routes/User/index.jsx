...
export const User = () => {
  ...
  return (
    <UserBox>
      <Overlay isOpen={viewDetail} setIsOpen={setViewDetail}>
        <UserModal
          style={{
            width: "1400px",
          }}
        >
          <span className="font-bold text-lg">"사용자 이름"</span>
          <Table
            headers={[
              "매체발급번호",
              "카드유형",
      ...
      <ToolbarBox>
        ...
        <Input height="40px" width="200px" placeholder="사원번호" />
        <Input height="40px" width="200px" placeholder="이름" />
        <Input height="40px" width="200px" placeholder="카드 ID" />
        <Button height="40px" width="60px" text="조회" />
      </ToolbarBox>
      <Table
        headers={["회사코드", "사원번호", "사용자 이름", "카드 ID 목록"]}
        gap
      />
      <TableBtns>
